...
<body>
    ...
    <script>
        // الكود الذي نريد عزله (يحتوي على HTML وCSS)
        const isolatedHTML = 
            <style>
                /* هذه التنسيقات ستكون معزولة */
                h1 {
                    color: red !important;
            ...
            <h1>عنوان داخل الكود المعزول</h1>
            <p class="my-class">هذا نص داخل الكود المعزول.</p>
        ;

        // إنشاء Shadow DOM وإضافة الكود المعزول
        const container = document.getElementById('isolated-container');
        const shadowRoot = container.attachShadow({ mode: 'open' });
        shadowRoot.innerHTML = isolatedHTML;
    </script>
</body>
</html>
