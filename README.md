...
<body>
 ...
 <a href="https://www.forexpeacearmy.com/forex-reviews/15906/rannforex-review" class="btn btn-outline" target="_blank">
  ...
  <a href="https://www.wikifx.com/en/dealer/1141850612.html" class="btn btn-outline" target="_blank">
    ...
    <footer class="footer">
        <div class="container">
            <p>تنبيه هام:تنطوي المنتجات المالية التي تتضمن استخدام الرافعة المالية على مخاطر كبيرة على استثماراتك. قد تؤدي التقلبات الشديدة في السوق إلى خسائر تفوق إيداعك الأولي </p>
        </div>
    </footer>
