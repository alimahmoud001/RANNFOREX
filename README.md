...
<body>
 ...
 ====
  <button class="btn" id="showDepositSteps">
        ...
        <div class="card">
            <h2><i class="fas fa-wallet"></i> محفظة التداول</h2>
            <p>إدارة أموالك بشكل فعال مع محفظة RannForex المتكاملة. تتبع معاملاتك، وتحقق من أرصدتك، وقم بإجراء التحويلات بكل سهولة وأمان.</p>
            
            <div style="background: linear-gradient(135deg, #1a2a6c, #4a6fa5); border-radius: 12px; padding: 20px; color: white; margin-top: 25px;">
                <h3 style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                    <i class="fas fa-lock"></i> معلومات الأمان
                </h3>
                <p>جميع معاملاتك محمية بتقنية التشفير المتقدمة ومصادقة ثنائية لضمان أقصى درجات الحماية لاستثماراتك.</p>
            </div>
            
            <div style="display: flex; justify-content: space-between; margin-top: 30px;">
                <div style="text-align: center;">
                    <div style="background: #f0f5ff; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                        <i class="fas fa-sync-alt" style="font-size: 2rem; color: #1a2a6c;"></i>
                    </div>
                    <h3 style="color: #1a2a6c;">تحويلات فورية</h3>
                </div>
                <div style="text-align: center;">
                    <div style="background: #f0f5ff; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                        <i class="fas fa-percentage" style="font-size: 2rem; color: #1a2a6c;"></i>
                    </div>
                    <h3 style="color: #1a2a6c;">0% عمولة</h3>
                </div>
                <div style="text-align: center;">
                    <div style="background: #f0f5ff; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                        <i class="fas fa-globe" style="font-size: 2rem; color: #1a2a6c;"></i>
                    </div>
                    <h3 style="color: #1a2a6c;">دعم عالمي</h3>
                </div>
            </div>
        </div>
    </div>
